        ...
        <div className="space-y-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
                <div>
                    ...
                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-[0.2em]">Manage item requests and orders</p>
                </div>
                            ...
                            <div className="p-6 md:p-8 border-b border-gray-50 flex flex-wrap justify-between items-start gap-4">
                                ...
                                <div className="flex items-center gap-3">
                                    <div className="text-right mr-2">
                                        ...
                                        <div className={`mt-1 text-[9px] font-black uppercase px-3 py-1 rounded-full inline-block ${
                                    ...
                                    <button 
                                        ...
                                        className={`p-3 rounded-xl transition-all ${
                                            inquiry.status === "reviewed" ? "bg-green-100 text-green-600" : "bg-gray-100 text-gray-400 hover:bg-orange-50 hover:text-orange-500"
                                        }`}
                                    >
                                        <CheckCircle size={20} />
                                    </button>
                                ...
                                <div className="space-y-4">
                                    ...
                                    <div className="space-y-2 max-h-[220px] overflow-y-auto pr-2 custom-scrollbar">
                                        {inquiry.items?.map((item: any, idx: number) => (
                                            <div key={idx} className="flex items-center gap-4 bg-white p-3 rounded-2xl border border-gray-100 shadow-sm group/item hover:border-red-100 transition-colors">
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-[9px] font-bold text-gray-400 italic tracking-tighter uppercase">SKU: {item.sku}</p>
                                                </div>
